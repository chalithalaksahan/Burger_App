 ...
 * @author USER
 */
public class ProccessingOrdersForm extends javax.swing.JFrame {
     ...
     */
    public ProccessingOrdersForm(BurgerCollection burgerCollection) {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Proccessing Orders");
    ...
    private void initComponents() {
        ...
        label1.setText("Proccessing Orders");
    ...
    private void btnReloadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReloadActionPerformed
      ...
      dtm.setRowCount(0);
      Burger[] burgerArray=burgerCollection.checkStatus(Burger.PREPARING);
