...
public class PlaceOrderForm extends javax.swing.JFrame {
     ...
     */
    public PlaceOrderForm(BurgerCollection burgerCollection) {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Place Order");
        this.burgerCollection=burgerCollection;
        txtOrderId.setText(this.burgerCollection.generateBurgerId());
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
        ...
        burgerCollection.addBurger(burger);
            ...
            if(res==JOptionPane.YES_OPTION){
                ...
                txtOrderId.setText(burgerCollection.generateBurgerId());
    ...
    private void txtCustomerIdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCustomerIdKeyReleased
       if(txtCustomerId.getText().length()==10 && txtCustomerId.getText().charAt(0)=='0'){
           String CustomerName = burgerCollection.searchCustomerId(txtCustomerId.getText());
    ...
    private void txtOrderQtyKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtOrderQtyKeyReleased
        ...
        int OrderQty = Integer.parseInt(txtOrderQty.getText());
        if(OrderQty>=0){
        txtOrderTotal.setText(burgerCollection.getTotal(OrderQty));
        }else{
