...
public class BurgerMainForm extends javax.swing.JFrame {
    ...
    public BurgerMainForm() {
        ...
        burgerCollection = new BurgerCollection();
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
         new PlaceOrderForm(burgerCollection).setVisible(true);
    }//GEN-LAST:event_btnPlaceOrderActionPerformed

    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
         new SearchOrderForm(burgerCollection).setVisible(true);
    }//GEN-LAST:event_btnSearchActionPerformed

    private void btnViewOrdersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrdersActionPerformed
         new ViewOrdersMainForm(burgerCollection).setVisible(true);
    ...
    private void btnUpdateOrderDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateOrderDetailsActionPerformed
        new UpdateOrderForm(burgerCollection).setVisible(true);
    ...
    private void btnSearchBestCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchBestCustomerActionPerformed
         new SearchBestCustomerForm(burgerCollection).setVisible(true);
    }//GEN-LAST:event_btnSearchBestCustomerActionPerformed

    private void btnSearch1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearch1ActionPerformed
        new SearchCustomerForm(burgerCollection).setVisible(true);
