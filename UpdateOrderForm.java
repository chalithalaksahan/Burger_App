...
public class UpdateOrderForm extends javax.swing.JFrame {
     ...
     */
    public UpdateOrderForm(BurgerCollection burgerCollection) {
        initComponents();
    ...
    private void txtOrderIdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtOrderIdKeyReleased
        ...
        Burger burger = burgerCollection.searchBurger(orderId);
        if(burger!=null){
            txtCustomerId.setText(burger.getCustomerId());
            txtCustomerName.setText(burger.getCustomerName());
            txtOrderQty.setText("0"+burger.getOrderQty());
            txtTotal.setText(burger.getOrderQty()*Burger.burgerPrice+"");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        int status = cmbOrderStatus.getSelectedIndex();
        int oldStatus =burger.getOrderStatus();
        Burger newBurger;
        boolean isUpdate;
        switch (oldStatus) {
            case 0:
                newBurger = new Burger(orderId,customerId,customerName,orderQty,status);
                isUpdate = burgerCollection.updateBurger(newBurger);
                if(isUpdate){
            ...
            case 2:
                txtDisplayError.setText("<html>This order has been Cancelled.<br> Sorry, you can not update this order.</html>");
                break;
            default:
                break;
        }
    ...
    private void txtOrderQtyKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtOrderQtyKeyReleased
        int OrderQty = Integer.parseInt(txtOrderQty.getText());
        if(OrderQty>=0){
        txtTotal.setText(burgerCollection.getTotal(OrderQty));
        }
