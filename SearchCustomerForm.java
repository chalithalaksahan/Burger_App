...
public class SearchCustomerForm extends javax.swing.JFrame {
     ...
     */
    public SearchCustomerForm(BurgerCollection burgerCollection) {
        initComponents();
    ...
    private void txtCustomerIdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCustomerIdKeyReleased
        ...
        Burger[] customer=burgerCollection.searchCustomer(customerId);
        DefaultTableModel dtm = (DefaultTableModel) tblCustomerDetails.getModel();
        dtm.setRowCount(0);
        for (Burger burger : customer) {
            txtCustomerName.setText(burger.getCustomerName());
            Object[] rowData = {burger.getOrderId(),burger.getOrderQty(),burger.getOrderQty()*Burger.burgerPrice};
            dtm.addRow(rowData);
        }
